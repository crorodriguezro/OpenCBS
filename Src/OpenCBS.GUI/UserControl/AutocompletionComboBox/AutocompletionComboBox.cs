...
namespace OpenCBS.View.UserControl.AutocompletionComboBox
{
    /// <summary>
    ...
    /// </summary>
    public partial class AutocompletionComboBox : ComboBox
    {
        ...
        /// <summary>
        /// this where we can make suggestions
        /// </summary>
        /// <param name="e"></param>
        protected override void OnTextChanged(EventArgs e)
        {
            ...
            m_suggestionList.BackColor = Color.White;

            //if (m_suggestionList.Items.Count == 0)
            //    BackColor = Color.Red;
            //else
