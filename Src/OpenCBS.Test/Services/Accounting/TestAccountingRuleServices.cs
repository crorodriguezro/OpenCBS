...
namespace OpenCBS.Test.Services.Accounting
{
    ...
    public class TestAccountingRuleServices
    {
        ...
        public void Test_ProvisionLoanProcessing()
        {
            ...
            provisionTable.Add(new ProvisioningRate { Number = 1, NbOfDaysMin = 0, NbOfDaysMax = 0, ProvisioningOlb = 0.5, ProvisioningInterest = 0.5, ProvisioningPenalty = 0.5 });
            provisionTable.Add(new ProvisioningRate { Number = 2, NbOfDaysMin = 1, NbOfDaysMax = 30, ProvisioningOlb = 1, ProvisioningInterest = 1, ProvisioningPenalty = 1 });
            provisionTable.Add(new ProvisioningRate { Number = 3, NbOfDaysMin = 31, NbOfDaysMax = 60, ProvisioningOlb = 1.5, ProvisioningInterest = 1.5, ProvisioningPenalty = 1.5 });
            provisionTable.Add(new ProvisioningRate { Number = 3, NbOfDaysMin = 60, NbOfDaysMax = 999, ProvisioningOlb = 2, ProvisioningInterest = 2, ProvisioningPenalty = 2 });
