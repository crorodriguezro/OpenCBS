...
namespace OpenCBS.Test.CoreDomain.Contracts.CalculateInstallments
{
    ...
    public class DecliningRateWithoutCents
    {
        ...
        public void TestFixtureSetUp()
        {
            ...
            provisionTable.Add(new ProvisioningRate { Number = 1, NbOfDaysMin = 0, NbOfDaysMax = 30, ProvisioningOlb = 10, ProvisioningInterest = 10, ProvisioningPenalty = 10 });
            provisionTable.Add(new ProvisioningRate { Number = 2, NbOfDaysMin = 31, NbOfDaysMax = 60, ProvisioningOlb = 25, ProvisioningInterest = 25, ProvisioningPenalty = 25 });
            provisionTable.Add(new ProvisioningRate { Number = 3, NbOfDaysMin = 61, NbOfDaysMax = 90, ProvisioningOlb = 50, ProvisioningInterest = 50, ProvisioningPenalty = 50 });
            provisionTable.Add(new ProvisioningRate { Number = 4, NbOfDaysMin = 91, NbOfDaysMax = 180, ProvisioningOlb = 75, ProvisioningInterest = 75, ProvisioningPenalty = 75 });
            provisionTable.Add(new ProvisioningRate { Number = 5, NbOfDaysMin = 181, NbOfDaysMax = 365, ProvisioningOlb = 100, ProvisioningInterest = 100, ProvisioningPenalty = 100 });
            provisionTable.Add(new ProvisioningRate { Number = 6, NbOfDaysMin = 366, NbOfDaysMax = 99999, ProvisioningOlb = 100, ProvisioningInterest = 100, ProvisioningPenalty = 100 });
