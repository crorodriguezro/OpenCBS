...
ALTER TABLE dbo.Installments ADD last_interest_accrual_date DATE NULL DEFAULT(0)
GO

if col_length('dbo.InstallmentHistory','last_interest_accrual_date') is null
ALTER TABLE dbo.InstallmentHistory ADD last_interest_accrual_date DATE NULL DEFAULT(0)
GO
